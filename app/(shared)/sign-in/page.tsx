...
const SignInPage: React.FC<TProps> = () => {
	return (
		<div
			className={cn(
				` flex items-center justify-center bg-gradient-to-b from-white to-gray-200  rounded-md`
			)}
		>
			<div className="bg-white shadow-lg rounded-md p-10 w-full max-w-md text-center relative">
				...
				<div className="mt-6 mb-8">
					<h2 className="text-lg font-semibold text-gray-700 italic">
						&quot;Sự sang trọng không phải là nổi bật mà là được ghi
						nhớ.&quot;
					</h2>
				</div>
				...
				<Button
					...
					onClick={() =>
						signIn("keycloak", { callbackUrl: routes.home })
					}
				>
					Đăng nhập
				</Button>
				...
				<div className="mt-8 text-gray-600 text-sm">
					<p>
						Khám phá sự sang trọng vượt thời gian của bộ sưu tập độc
						quyền của chúng tôi.
					</p>
				</div>
			</div>
